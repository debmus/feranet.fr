...
|`sed '/^word1.*/a word2' fichier.txt`| Insérer une ligne après la correspondance trouvée |
|`sed '/^word1.*/i word2' fichier.txt`| Insérer une ligne avant que la correspondance ne soit trouvée |
